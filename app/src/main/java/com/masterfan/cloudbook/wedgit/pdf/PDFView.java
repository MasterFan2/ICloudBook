...
public class PDFView extends SurfaceView {
    ...
    public Configurator fromAsset(String assetName) {
        try {
           // File pdfFile = FileUtils.fileFromAsset(getContext(), assetName);//从main下的assets中获取文件
            File pdfFile = new File(Environment.getExternalStorageDirectory()+ "/"+assetName);//从SD卡中获取文件
