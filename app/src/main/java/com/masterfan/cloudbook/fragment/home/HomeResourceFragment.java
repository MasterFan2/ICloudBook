...
public class HomeResourceFragment extends MTFBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    private MTFRecyclerViewAdapterWrapper adapterWrapper;
    private MyAdapter adapter;
    private LayoutInflater mLayoutInflater;

    @Bind(R.id.fragment_home_resource_recyclerView_refreshLayout)
    SwipeRefreshLayout refreshLayout;

    private ArrayList<FragmentIndexBookEntity> dataList = new ArrayList<>();

    @Bind(R.id.fragment_home_resource_recyclerView)
