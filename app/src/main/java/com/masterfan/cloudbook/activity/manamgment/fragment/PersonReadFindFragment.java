 ...
 *个人阅读查询
 */
@MTFFragmentFeature(layout = R.layout.fragment_person_read_find)
public class PersonReadFindFragment extends MTFBaseFragment{

	@Bind(R.id.fragment_person_read_find_button)
	Button findBtn;
	...
	@OnClick(R.id.fragment_person_read_find_button)
	public void onclickBtn(View view){
		Intent intent = new Intent(getActivity(), PersonReadListActivity.class);
		if(intent != null){
