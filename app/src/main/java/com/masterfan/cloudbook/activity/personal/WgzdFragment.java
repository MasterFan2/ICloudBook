 ...
 * 我关注的书友
 */
@MTFFragmentFeature(layout = R.layout.fragment_wgzd)
public class WgzdFragment extends MTFBaseFragment {

	@Bind(R.id.fragment_wgzd_listview)
	ListView listView;
	...
	private void initMettingFrament() {
		...
		Person person = new Person("张三","老师",11,11,11,"我关注的");
		list.add(person);
		person = new Person("张三1","老师1",22,22,22,"我关注的");
		list.add(person);
		person = new Person("张三2","老师11",33,33,33,"我关注的");
		list.add(person);
		person = new Person("张三3","老师1",22,22,22,"我关注的");
		list.add(person);
		person = new Person("张三4","老师11",33,33,33,"我关注的");
		list.add(person);
		person = new Person("张三5","老师1",22,22,22,"我关注的");
		list.add(person);
		person = new Person("张三6","老师11",33,33,33,"我关注的");
		list.add(person);
		person = new Person("张三7","老师1",22,22,22,"我关注的");
		list.add(person);
		person = new Person("张三8","老师11",33,33,33,"我关注的");
		list.add(person);
		person = new Person("张三8","老师1",22,22,22,"我关注的");
		list.add(person);
		person = new Person("张三10","老师11",33,33,33,"我关注的");
		list.add(person);
