...
public class AlertDialogWrapper {
    ...
    public static class Builder {
        ...
        private final MTFDialog.Builder builder;
        ...
        public Builder(@NonNull Context context) {
            builder = new MTFDialog.Builder(context);
        }
        ...
        public Builder setAdapter(ListAdapter adapter, final DialogInterface.OnClickListener listener) {
            ...
            builder.listCallbackCustom = new MTFDialog.ListCallback() {
                @Override
                public void onSelection(MTFDialog dialog, View itemView, int which, CharSequence text) {
        ...
        private void addListCallbacks() {
            if (onClickListener != null) {
                builder.itemsCallback(new MTFDialog.ListCallback() {
                    @Override
                    public void onSelection(MTFDialog dialog, View itemView, int which, CharSequence text) {
        ...
        private void addButtonsCallback() {
            if (positiveDialogListener != null || negativeDialogListener != null) {
                builder.callback(new MTFDialog.ButtonCallback() {
                    @Override
        ...
        private void setUpMultiChoiceCallback(@Nullable final boolean[] checkedItems, final DialogInterface.OnMultiChoiceClickListener listener) {
            ...
            builder.itemsCallbackMultiChoice(selectedIndicesArr, new MTFDialog.ListCallbackMultiChoice() {
                @Override
        ...
        public Builder setSingleChoiceItems(@NonNull String[] items, int checkedItem, final DialogInterface.OnClickListener listener) {
            builder.items(items);
            builder.itemsCallbackSingleChoice(checkedItem, new MTFDialog.ListCallbackSingleChoice() {
                @Override
