package com.masterfan.library.dialog.tiles.gl;

import android.opengl.GLES20;
import android.util.Log;

import com.masterfan.library.dialog.tiles.interfaces.ShaderType;
	...
	public static int compileShader(@ShaderType final int shaderType, final String shaderSource) {
		...
		if (shaderHandle != 0) {
			...
			if (compilationStatus[0] == 0) {
				Log.e("Error Tiles", "Error compiling shader " + GLES20.glGetShaderInfoLog(shaderHandle));
