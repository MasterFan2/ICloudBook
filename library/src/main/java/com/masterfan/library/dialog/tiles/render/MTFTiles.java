...
import com.masterfan.library.dialog.tiles.interfaces.Renderable;
 ...
 */
public class MTFTiles implements Renderable {

    private final int mBufferId;
    private final MTFRenderer mRenderer;

    public MTFTiles(MTFRenderer renderer, FloatBuffer vboBuffer) {
