package com.masterfan.library.dialog.tiles.render;
...
import com.masterfan.library.dialog.tiles.Const;
import com.masterfan.library.dialog.tiles.TilesFrameLayout;
import com.masterfan.library.dialog.tiles.gl.RawResourceReader;
import com.masterfan.library.dialog.tiles.gl.ShaderHelper;
import com.masterfan.library.dialog.tiles.gl.TextureHelper;
 ...
 */
public class MTFRenderer implements GLSurfaceView.Renderer {
    /** Store the accumulated rotation. */
    private final float[] mAccumulatedRotation = new float[16];
    /** Store the current rotation. */
    private final float[] mCurrentRotation = new float[16];
    public MTFTiles mPlane;
    ...
    public MTFRenderer(MTFTilesGLSurfaceView glSurfaceView,
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        final String vertexShader = RawResourceReader.readTextFileFromRawResource(mGlSurfaceView.getContext(), R.raw.mtf_tiles_vert);
        final String fragmentShader = RawResourceReader.readTextFileFromRawResource(mGlSurfaceView.getContext(), R.raw.mtf_tiles_frag);
    ...
    public void logFrame() {
        ...
        if(timePassed >= 1000) {
            Log.d("MTFRenderer Error",  String.format("%d tiles @ %d fps", getTilesCount(), frames));
            frames = 0;
